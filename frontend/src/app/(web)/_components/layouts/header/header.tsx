        ...
        <div className="flex items-center justify-between h-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <motion.button
              ...
              className="md:hidden flex items-center justify-center w-10 h-10 rounded-xl border border-primary/20 text-primary hover:bg-primary/5 transition-colors duration-200"
            >
